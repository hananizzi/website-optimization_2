...
var resizePizzas = function(size) { 
  ...
  function changePizzaSizes(size) {
          ...
          // I determined the sizes first and applied them to all the pizzas instead of finding the sizes everytime the loop runs.
...
function updatePositions() {
        ...
        function changePosition(scrollTop) {
